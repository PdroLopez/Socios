...
<div class="container">
    ...
    <div class="card-body">
        ...
        <fieldset>
            ...
            <h2 style="text-align: center;">! Bienvenido  a la Inscripción de Socios de la Corporación Deportiva y Cultural de Everton de Viña del Mar !</h2>


            <a class="btn btn-info" href="{{asset('inscripcion-paso-2')}}" name="password" value="siguiente">Siguiente</a>
  ...
  <div class="card-body">
    <fieldset>
      ...
      <div class="row">
        ...
        <a class="btn btn-info" href="{{asset('continuar/inscripcion')}}/{{ $item->codigo_inscripcion }}" name="password" value="siguiente">Siguiente</a>
        ...
        <div class="form-group">
            ...
            <div id="pertenece" style="display:none;">
                ...
                <div class="col-4">
                    ...
                    {!!Form::text('nombre_institucion',null,['class'=>"form-control", 'placeholder'=>"Ingrese institucion o agrupación..."])!!}
                </div>
                <div class="col-4">
                    <label for="">Telefono Institución*</label>
                    {!!Form::number('fono_institucion',null,['class'=>"form-control", 'placeholder'=>"Ingrese fono..."])!!}
                </div>
                <div class="col-4">
                    <label for="">Correo Institución*</label>

                    {!!Form::email('email_institucion',null,['class'=>"form-control", 'placeholder'=>"Ingrese correo..."])!!}
                </div>
                </div>
            </div>
        </div>
            ...
            <div id="sancionado" style="display:none;">
                <div class="row">
                    <div class="col-6">
                        ...
                        {!!Form::date('sancion_comienzo',null,['class'=>"form-control", 'placeholder'=>"Ingrese la fecha..."])!!}
                    </div>
                    <div class="col-6">
                        <label for="">Fecha Termino</label>
                        {!!Form::date('sancion_termino',null,['class'=>"form-control", 'placeholder'=>"Ingrese la fecha..."])!!}
                    </div>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div id="detenido" style="display:none;">
                <div class="row">
                    <div class="col-6">
                        <label for="">Fecha Inicial</label>
                        {!!Form::date('detencion_comienzo',null,['class'=>"form-control", 'placeholder'=>"Ingrese la fecha..."])!!}
                    </div>
                    <div class="col-6">
                        <label for="">Fecha Termino</label>
                        {!!Form::date('detencion_termino',null,['class'=>"form-control", 'placeholder'=>"Ingrese la fecha..."])!!}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div id="menor" style="display:none;">
                    <div class="row">
                        <div class="col-4">
                            ...
                            {!!Form::text('nombres_apoderado',null,['class'=>"form-control", 'placeholder'=>"Ingrese nombre apoderado..." , ])!!}                                    </div>
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            ...
                            {!!Form::text('rut_apoderado',null,['class'=>"form-control", 'placeholder'=>"Ingrese rut apoderado..."])!!}
                        </div>
                        <div class="col-6">
                            <br>
                            <label for="">Rut del Representante</label>
                            {!!Form::text('rut_representante',null,['class'=>"form-control", 'placeholder'=>"Ingrese rut apoderado..."])!!}
                        </div>
                        <div class="col-6">
                            <br>
                            <label for="">Rut del Patrocinante</label>
                            {!!Form::text('rut_patrocinante',null,['class'=>"form-control", 'placeholder'=>"Ingrese rut apoderado..."])!!}
                        </div>
                        <div class="col-6">
                            <br>
