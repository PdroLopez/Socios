...
<html lang="en" >
    <head>
        ...
        <link href="{{ asset('theme/dist/assets/css/pages/login/classic/login-4.css?v=7.0.6')}}" rel="stylesheet" type="text/css"/>
                ...
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('assets/media/bg/bg-3.jpg');">
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        <div class="d-flex flex-center mb-15">
                            <a href="#">
                                <img src="{{ asset('img/midas.png') }}" class="max-h-75px" alt=""/>
                            </a>
                        </div>
    ...
    <script>var HOST_URL = "https://preview.keenthemes.com/metronic/theme/html/tools/preview";</script>
            ...
            <script src="{{ asset('theme/dist/assets/plugins/global/plugins.bundle.js?v=7.0.6')}}"></script>
            <script src="{{ asset('theme/dist/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.0.6')}}"></script>
            <script src="{{ asset('theme/dist/assets/js/scripts.bundle.js?v=7.0.6')}}"></script>
            <script src="{{ asset('theme/dist/assets/js/pages/custom/login/login-general.js?v=7.0.6')}}"></script>
