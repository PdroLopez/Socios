...
<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed aside-enabled aside-static page-loading">
  ...
  <div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
    <a href="{{asset('/')}}">
      <img alt="Logo" src="{{asset('img/logo.png')}}" class="logo-default max-h-70px" />
    </a>
            ...
            <ul class="menu-nav">
              <li class="ml-5">
                <div class="row">
                  ...
                  <a href="{{asset('login')}}" style="background-color:#032273 !important; color:#fbcd00 !important;" class="btn btn-light-primary font-weight-bold ml-5 mb-4">Ingresar</a> @endif
                ...
                <li class="menu-item" aria-haspopup="true">
                  <a href="{{asset('/donacion')}}" class="menu-link">
                    <span class="svg-icon menu-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          <polygon points="0 0 24 0 24 24 0 24" />
                    ...
                    <span class="menu-text">Donación</span>
                  </a>
                </li>

                <li class="menu-item" aria-haspopup="true">
                  <a href="{{asset('inscripcion')}}" class="menu-link">
                    <span class="svg-icon menu-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          <polygon points="0 0 24 0 24 24 0 24" />
                    ...
                    <span class="menu-text">suscripción</span>
                  </a>
                </li>

                <li class="menu-item" aria-haspopup="true">
                  <a href="{{asset('preguntas')}}" class="menu-link">
                    <span class="svg-icon menu-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          <polygon points="0 0 24 0 24 24 0 24" />
                ...
                @if (Auth::check())
                  @if(Auth::user()->rol->nombre == 'Participante')
                    <li class="menu-item" aria-haspopup="true">
                      <a href="{{asset('private/juegos')}}" class="menu-link">
                        ...
                        <span class="menu-text">{{ Auth::user()->rol->nombre}}</span>
                      </a>
                    </li>
                  @else
                    <li class="menu-item" aria-haspopup="true">
        ...
        <div id="kt_header" class="header header-fixed">
          <div class="container d-flex align-items-stretch justify-content-between">
            <div class="d-none d-lg-flex align-items-center mr-3">
              ...
              <a href="{{asset('/')}}">
                <img alt="Logo" src="{{asset('img/logo.png')}}" class="logo-sticky max-h-80px" />
              </a>
            ...
            <div id="nav-xl" class="nav nav-dark order-1 order-md-2">
              ...
              <a href="{{asset('donacion')}}" class="nav-link pr-3 pl-0">Donacion</a>
              <a href="{{asset('preguntas')}}" class="nav-link pr-3 pl-0">Preguntas</a>
              <a href="{{asset('contacto')}}" class="nav-link pr-3 pl-0">Contactos</a>
              <a href="{{asset('inscripcion')}}" class="nav-link pr-3 pl-0">Inscripcion</a>
              @if (Auth::check())
                @if(Auth::user()->rol->nombre == 'Participante')
                  <a href="{{asset('private/juegos')}}" class="nav-link px-3 pl-0">{{ Auth::user()->rol->nombre}}</a>
                @else
                  <a href="{{asset('/home')}}" class="nav-link px-3 pl-0">{{ Auth::user()->rol->nombre}}</a>
                @endif
                <a class="btn btn-danger nav-link pr-3 pl-2" style="height: 50%; margin-top: 20px; margin-left: 20px;" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Cerrar Sesión') }}</a>
              @else
              <a href="{{asset('login')}}" class="btn btn-danger nav-link px-3 pl-0" style="height: 50%; margin-top: 20px; margin-left: 20px; background-color:#032273 !important; color:#fbcd00 !important;">Ingresar</a>
              @endif
